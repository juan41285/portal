        ...
        var publicMethods = {
          ...
          open: function (opts) {
            ...
            function generateTemplate(images) {
              scope.images = images;
              var template = '<div class="gallery"> <img src="http://portal.tictucuman.net/images/logo-coord-largo.png" alt="Logo coordinación Provincial TIC" class="img-responsive logo"><button class="gallery-close-btn ' + options.closeClass + '" data-ng-click="closeThisDialog()">' + options.closeLabel + '</button>';
              for (var i = 0; i < images.length; ++i) {
                template += '<div class="gallery-item animate-show" data-ng-show="visibleID === ' + i + '" data-ng-click="closeGallery($event)"><span class="helper"></span><span  data-ng-click="nextImage()"><img src="http://tictucuman.net/Pagina/' + options.prefix + images[i] + '"/></span></div>';
              }
